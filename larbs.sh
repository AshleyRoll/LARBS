...
# DEFAULTS:
[ -z ${dotfilesrepo+x} ] && dotfilesrepo="https://github.com/AshleyRoll/voidrice.git"
[ -z ${progsfile+x} ] && progsfile="https://raw.githubusercontent.com/AshleyRoll/LARBS/master/progs.csv"
