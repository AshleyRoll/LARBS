...
# DEFAULTS:
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/AshleyRoll/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/AshleyRoll/LARBS/master/progs.csv"
